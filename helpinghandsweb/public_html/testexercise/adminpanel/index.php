    ...
    <a href="#Users">
     <md-list-item class="menu1"  ng-click="null" >          
          <div class="md-list-item-text" layout="row">
            <md-icon md-font-icon="material-icons">chat</md-icon>&nbsp;&nbsp;Add Users
          </div>          
     </md-list-item>
     </a>
...
<div layout="column" tabindex="-1" role="main" flex="" class="layout-column flex">
    ...
    <md-button aria-label="Open demo menu" class="md-icon-button" ng-click="$mdOpenMenu($event)">
        ...
        <md-menu md-position-mode="target-right target">
          ...
          <md-button aria-label="Open demo menu" class="md-icon-button" ng-click="$mdOpenMenu($event);listNotify();">
            <md-icon md-menu-origin="" md-font-icon="material-icons">add_alert</md-icon>
          </md-button>
          <md-menu-content width="4">            
            <md-menu-item ng-repeat="n in notifdata">
              <md-button ng-click="userView(n.p_id)">
                  <div layout="row" flex="">
                    <p flex="">{{n.p_fname}} did some changes on {{n.mod_type}}</p>
                    <md-icon md-menu-align-target="" md-font-icon="material-icons" style="margin: auto 3px auto 0;">check_circle</md-icon>
                  </div>
              </md-button>
            </md-menu-item>
