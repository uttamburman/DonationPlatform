...
include ('data.php');
	  ...
	  $verif = $data->ver;
	  $posit = $data->posit;
	  $subposit = $data->subposit;
	  $resx1=$connection->selectTable("SELECT email from membersdata where id='".$id."' order by id desc limit 1;"); 
	  $email='';
	  if ($resx1->num_rows > 0) {
	  ...
	  echo $email;
	  $sql = "update membersdata set role='".$role."', adminverif='".$verif."', posit='".$posit."', subposit='".$subposit."' where id='".$id."';";
...
<link href='https://fonts.googleapis.com/css?family=Raleway:100,200,300,400,500,600,700,800,900' rel='stylesheet' type='text/css'>
  ...
  <body> 
	...
	<b>Verification Details</b>
  	<b><br>You have been VERIFIED from our side</b>
	    <p style=\"font-size:16px; font-weight:500;color:black;width:100%;text-align:center;\">Please login at:</p>
